  ...
  computed: {
    showList: function showList() {
      ...
      if (this.childrenField) {
        ...
        var _i = 0;
        for (_i; _i < this.store.length && list.length < count; _i++) {
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('zg-select', {
    ...
    return [(_vm.childrenField && item._show) ? _c('zg-opt-group', {
      attrs: {
        "label": item[_vm.labelField]
      }
    }, _vm._l((item[_vm.childrenField]), function(option) {
      return (option._show) ? _c('zg-option', {
