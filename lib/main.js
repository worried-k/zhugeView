    ...
    showList: function showList() {
      ...
      if (this.childrenField) {
        for (var i = 0; i < this.store.length; i++) {
          ...
          var isBreak = false;
          for (var j = 0; j < item[this.childrenField].length; j++) {
            if (resultCount > count) {
              isBreak = true;
              break;
            }
            var child = item[this.childrenField][j];
        ...
        var _i = 0;
        for (_i; _i < this.store.length && _i < count; _i++) {
          var _item = this.store[_i];
          if (!this.filterValue || this.filterValue && _item[this.labelField].indexOf(this.filterValue) > -1) {
            list.push(_item);
          }
        }
      }
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('zg-select', {
    ...
    }, _vm._l((item[_vm.childrenField]), function(option, i) {
      return (i < _vm.currentCount && _vm.showMap[option[_vm.keyField]]) ? _c('zg-option', {
